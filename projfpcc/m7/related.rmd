...
systems. Yet, despite its importance, scalability in applications is poorly
...
As modeling a complex system such as JVM, approaches like JVM auto-tuning have
...
could be mixed with application trial runs to help on achieve a fast, online tunning.
