...
Para tal, criamos a ferramenta [github/archive2csv](https://github.com/danielfireman/phd/tree/master/github/archive2csv). A ferramenta descomprime o conteúdo que recebe via entrada padrão e, para linha cada linha, decodifica o objeto JSON extraindo os campos de interesse. Depois de extraído e tratado o conteúdo, uma linha no formato CSV é então impressa na saída padrão.
