...
Através desses gráficos vemos que o valor máximo da função de utilidade ocorre aproximadament em $|T|=200$ e $|T|=50$ para $\alpha=0.2$ e $\alpha=0.95$ respectivamente.
